...
@FacesConverter(value = "funcionarioConverterWalterPaulo")
public class FuncionarioConverterWalterPaulo implements Converter {
	...
	public Object getAsObject(FacesContext arg0, 
		...
		if (valor != null) {
			FuncionarioDAOWalterPaulo dao = new FuncionarioDAOWalterPaulo();
			try {
	...
	public String getAsString(FacesContext arg0, 
		...
		if (valor != null) {
			return String.valueOf(((FuncionarioWalterPaulo)valor).getId());
		}
		return null;
	}
